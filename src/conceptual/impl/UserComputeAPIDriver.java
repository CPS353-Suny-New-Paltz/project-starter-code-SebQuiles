...
public class UserComputeAPIDriver {
    ...
    public void networkAPIPrototype(UserComputeAPI api) {
        ...
        UserJobRequest req = new UserJobRequest() {
            @Override public String getInputSource()       { return "numbers.txt"; }
            @Override public String getOutputDestination() { return "output.txt"; }
            @Override public Character getPairSeparator()  { return null; } // defaults OK
            @Override public Character getKvSeparator()    { return null; } // defaults OK
        };
